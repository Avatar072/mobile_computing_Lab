...
class ImageUploadLayout(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        # 返回按鈕
        return_button = Button(text='R', size_hint=(None, None), size=(50, 50), pos_hint={'right': 1, 'top': 1})
        return_button.bind(on_release=self.return_to_main_page)
        self.add_widget(return_button)

        # 上傳按鈕
        upload_button = Button(text='U', size_hint=(None, None), size=(50, 50), pos_hint={'right': 1, 'top': 0.9})
